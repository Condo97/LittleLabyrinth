...
public class mediumLvl3 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        Player player = new Player(new Rect(0, (int)(.25*Constants.screenHeight), 50, (int)(.25*Constants.screenHeight) + 50), Color.RED);
        ...
        obstacles.add(new Obstacle(new Rect(0, player.getRect().bottom + 20, goal.getRect().right + 100, goal.getRect().top - 15), Color.BLACK));
        ...
        obstacles.add(new Obstacle(new Rect((Constants.screenWidth/4) + 100, 0, (Constants.screenWidth/4) + 175, player.getRect().top - 75), Color.BLACK));
        obstacles.add(new Obstacle(new Rect(player.getRect().right + 190, player.getRect().top - 75, (int)(.8*Constants.screenWidth), player.getRect().top), Color.BLACK));
        obstacles.add(new Obstacle(new Rect((int)(.8*Constants.screenWidth) - 75, player.getRect().top, (int)(.8*Constants.screenWidth), Constants.screenHeight/2), Color.BLACK));
        ...
        obstacles.add(new Obstacle(new Rect(goal.getRect().right + 10, goal.getRect().top + 160, Constants.screenWidth, Constants.screenHeight), Color.BLACK));
        ...
        obstacles.add(new Obstacle(new Rect(player.getRect().right + 190, goal.getRect().top - 15, goal.getRect().left - 105, Constants.screenHeight), Color.BLACK));
